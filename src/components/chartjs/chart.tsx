...
const ChartComponent = ({ onDataUpdate }: ChartComponentProps) => {
  ...
  useEffect(() => {
    ...
    // Since these variables are only used within the interval callback and don't need
    // to trigger effect re-runs, we can safely ignore them in the dependency array
